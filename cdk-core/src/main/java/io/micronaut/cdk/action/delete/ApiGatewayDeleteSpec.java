 ...
 */
public class ApiGatewayDeleteSpec<D extends ApiGatewayDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    ApiGatewayDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends ApiGatewayDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends ApiGatewayDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new ApiGatewayDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
