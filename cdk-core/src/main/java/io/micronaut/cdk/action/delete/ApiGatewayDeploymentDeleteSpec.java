 ...
 */
public class ApiGatewayDeploymentDeleteSpec<D extends ApiGatewayDeploymentDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    ApiGatewayDeploymentDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends ApiGatewayDeploymentDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends ApiGatewayDeploymentDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new ApiGatewayDeploymentDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
