 ...
 */
public class ApmDomainDeleteSpec<D extends ApmDomainDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    ApmDomainDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends ApmDomainDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends ApmDomainDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new ApmDomainDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
