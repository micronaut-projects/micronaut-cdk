 ...
 */
public class ApplicationDeleteSpec<D extends ApplicationDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    ApplicationDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends ApplicationDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends ApplicationDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new ApplicationDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
