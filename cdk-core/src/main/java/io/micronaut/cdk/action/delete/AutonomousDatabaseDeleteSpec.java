 ...
 */
public class AutonomousDatabaseDeleteSpec<D extends AutonomousDatabaseDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    AutonomousDatabaseDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends AutonomousDatabaseDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends AutonomousDatabaseDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new AutonomousDatabaseDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
