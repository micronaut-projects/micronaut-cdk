 ...
 */
public class CognitoUserPoolDeleteSpec<D extends CognitoUserPoolDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    CognitoUserPoolDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends CognitoUserPoolDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends CognitoUserPoolDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new CognitoUserPoolDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
