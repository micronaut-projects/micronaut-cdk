 ...
 */
public class ContainerRepositoryDeleteSpec<D extends ContainerRepositoryDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    ContainerRepositoryDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends ContainerRepositoryDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends ContainerRepositoryDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new ContainerRepositoryDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
