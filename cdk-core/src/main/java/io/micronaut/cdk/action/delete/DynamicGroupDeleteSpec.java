 ...
 */
public class DynamicGroupDeleteSpec<D extends DynamicGroupDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    DynamicGroupDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends DynamicGroupDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends DynamicGroupDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new DynamicGroupDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
