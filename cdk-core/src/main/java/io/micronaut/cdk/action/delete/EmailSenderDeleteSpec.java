 ...
 */
public class EmailSenderDeleteSpec<D extends EmailSenderDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    EmailSenderDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends EmailSenderDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
            @NonNull String emailAddress) {
        return builder(emailAddress, true);
    }
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends EmailSenderDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new EmailSenderDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
