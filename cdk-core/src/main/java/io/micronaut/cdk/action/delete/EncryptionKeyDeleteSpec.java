 ...
 */
public class EncryptionKeyDeleteSpec<D extends EncryptionKeyDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    protected EncryptionKeyDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends EncryptionKeyDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
            @NonNull String id,
            boolean byCdkId) {
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends EncryptionKeyDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new EncryptionKeyDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
