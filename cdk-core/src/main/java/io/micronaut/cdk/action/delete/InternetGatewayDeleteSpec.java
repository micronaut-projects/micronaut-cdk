 ...
 */
public class InternetGatewayDeleteSpec<D extends InternetGatewayDeleteSpec<D>> extends DeleteSpec<D> {

    InternetGatewayDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends InternetGatewayDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends InternetGatewayDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new InternetGatewayDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
