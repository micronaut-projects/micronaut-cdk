 ...
 */
public class KafkaClusterDeleteSpec<D extends KafkaClusterDeleteSpec<D>> extends DeleteSpec<D> {

    KafkaClusterDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends KafkaClusterDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends KafkaClusterDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new KafkaClusterDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
