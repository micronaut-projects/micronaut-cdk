 ...
 */
public class KubernetesClusterDeleteSpec<D extends KubernetesClusterDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    KubernetesClusterDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends KubernetesClusterDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends KubernetesClusterDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new KubernetesClusterDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
