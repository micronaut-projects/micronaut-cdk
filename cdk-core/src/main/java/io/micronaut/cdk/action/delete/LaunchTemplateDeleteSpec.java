 ...
 */
public class LaunchTemplateDeleteSpec<D extends LaunchTemplateDeleteSpec<D>> extends DeleteSpec<D> {

    LaunchTemplateDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends LaunchTemplateDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends LaunchTemplateDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new LaunchTemplateDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
