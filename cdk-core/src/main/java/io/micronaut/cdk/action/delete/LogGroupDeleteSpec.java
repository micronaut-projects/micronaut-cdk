 ...
 */
public class LogGroupDeleteSpec<D extends LogGroupDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    LogGroupDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends LogGroupDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends LogGroupDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new LogGroupDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
