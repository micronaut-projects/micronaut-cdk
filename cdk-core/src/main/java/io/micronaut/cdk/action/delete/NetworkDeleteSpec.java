 ...
 */
public class NetworkDeleteSpec<D extends NetworkDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    NetworkDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends NetworkDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends NetworkDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new NetworkDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
