 ...
 */
public class NotificationTopicDeleteSpec<D extends NotificationTopicDeleteSpec<D>> extends DeleteSpec<D> {

    NotificationTopicDeleteSpec(@NonNull String id,
    ...
    /**
     * Creates a Builder for the delete spec.
     *
     * @param id      the id
     ...
     */
    @NonNull
    public static <D extends NotificationTopicDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends NotificationTopicDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {

        Builder(@NonNull String id, boolean byCdkId) {
            super(id, byCdkId, NotificationTopic.class);
        }
        ...
        public D doBuild() throws InvalidActionException {
            validate();
            return (D) new NotificationTopicDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
