 ...
 */
public class RouteTableDeleteSpec<D extends RouteTableDeleteSpec<D>> extends DeleteSpec<D> {

    RouteTableDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends RouteTableDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends RouteTableDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new RouteTableDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
