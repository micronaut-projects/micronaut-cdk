 ...
 */
public class SecretDeleteSpec<D extends SecretDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    SecretDeleteSpec(@NonNull String id,
     ...
     *                        instance doesn't exist
     * @param newName         optional new name
     * @param vaultReference  the vault reference
     */
    SecretDeleteSpec(@NonNull String id,
                     @NonNull Collection<String> stacks,
                     boolean byCdkId,
                     boolean errorIfNotFound,
                     @Nullable String newName,
                     @NonNull ComponentReference vaultReference) {
        super(id, stacks, byCdkId, errorIfNotFound, newName, vaultReference);
    }
     ...
     */
    @NonNull
    public static <D extends SecretDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
            @NonNull String id,
            boolean byCdkId) {
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends SecretDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
