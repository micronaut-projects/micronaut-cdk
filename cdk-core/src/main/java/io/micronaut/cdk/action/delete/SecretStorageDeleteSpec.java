 ...
 */
public class SecretStorageDeleteSpec<D extends SecretStorageDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    SecretStorageDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends SecretStorageDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends SecretStorageDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new SecretStorageDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
