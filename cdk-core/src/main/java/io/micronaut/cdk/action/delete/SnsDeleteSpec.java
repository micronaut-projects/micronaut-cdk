 ...
 */
public class SnsDeleteSpec<D extends SnsDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    SnsDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends SnsDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends SnsDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
