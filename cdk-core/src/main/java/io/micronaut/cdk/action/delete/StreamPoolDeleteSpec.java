 ...
 */
public class StreamPoolDeleteSpec<D extends StreamPoolDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    StreamPoolDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends StreamPoolDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends StreamPoolDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new StreamPoolDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
