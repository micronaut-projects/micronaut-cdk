 ...
 */
public class TargetGroupDeleteSpec<D extends TargetGroupDeleteSpec<D>> extends DeleteSpec<D> {

    TargetGroupDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends TargetGroupDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends TargetGroupDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new TargetGroupDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
