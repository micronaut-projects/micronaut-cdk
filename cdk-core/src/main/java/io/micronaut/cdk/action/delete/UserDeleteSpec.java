 ...
 */
public class UserDeleteSpec<D extends UserDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    UserDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends UserDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends UserDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
