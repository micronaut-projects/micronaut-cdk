 ...
 */
public class UserGroupDeleteSpec<D extends UserGroupDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    UserGroupDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends UserGroupDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends UserGroupDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new UserGroupDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
