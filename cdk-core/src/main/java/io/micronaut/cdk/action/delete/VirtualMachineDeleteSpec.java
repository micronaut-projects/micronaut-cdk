 ...
 */
public class VirtualMachineDeleteSpec<D extends VirtualMachineDeleteSpec<D>> extends DeleteSpec<D> {
     ...
     */
    VirtualMachineDeleteSpec(@NonNull String id,
     ...
     */
    @NonNull
    public static <D extends VirtualMachineDeleteSpec<D>, B extends Builder<D, B>> Builder<D, B> builder(
     ...
     * @param <B> the builder type
     */
    public static class Builder<D extends VirtualMachineDeleteSpec<D>, B extends Builder<D, B>> extends DeleteSpec.Builder<D, B> {
        ...
        protected D doBuild() throws InvalidActionException {
            return (D) new VirtualMachineDeleteSpec<>(
                    getId(),
                    getStacks(),
                    isByCdkId(),
                    isErrorIfNotFound(),
