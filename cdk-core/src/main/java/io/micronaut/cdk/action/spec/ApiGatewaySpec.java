 ...
 */
@ResourceSpec(component = ApiGateway.class)
public class ApiGatewaySpec<S extends ApiGatewaySpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected ApiGatewaySpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends ApiGatewaySpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
