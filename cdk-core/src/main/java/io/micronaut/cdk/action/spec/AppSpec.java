 ...
 */
@ResourceSpec(component = App.class)
public class AppSpec<S extends AppSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected AppSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends AppSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
