 ...
 */
@ResourceSpec(component = Dkim.class)
public class DkimSpec<S extends DkimSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected DkimSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends DkimSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
