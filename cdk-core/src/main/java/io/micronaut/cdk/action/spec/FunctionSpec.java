 ...
 */
@ResourceSpec(component = Function.class)
public class FunctionSpec<S extends FunctionSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected FunctionSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends FunctionSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
