 ...
 */
@ResourceSpec(component = Grant.class)
public class GrantSpec<S extends GrantSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected GrantSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends GrantSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
