...
/**
 * InternetGateway spec.
 *
 * @param <S> the spec type
 */
@ResourceSpec(component = InternetGateway.class)
public class InternetGatewaySpec<S extends InternetGatewaySpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected InternetGatewaySpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends InternetGatewaySpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
