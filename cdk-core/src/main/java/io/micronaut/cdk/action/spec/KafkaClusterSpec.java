 ...
 */
@ResourceSpec(component = KafkaCluster.class)
public class KafkaClusterSpec<S extends KafkaClusterSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected KafkaClusterSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends KafkaClusterSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
