 ...
 */
@ResourceSpec(component = Log.class)
public class LogSpec<S extends LogSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected LogSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends LogSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
