 ...
 */
@ResourceSpec(component = Secret.class)
public class SecretSpec<S extends SecretSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected SecretSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends SecretSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
