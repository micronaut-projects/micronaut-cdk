 ...
 */
@ResourceSpec(component = SmtpCredential.class)
public class SmtpCredentialSpec<S extends SmtpCredentialSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected SmtpCredentialSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends SmtpCredentialSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
