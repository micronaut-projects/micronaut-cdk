 ...
 */
@ResourceSpec(component = Sns.class)
public class SnsSpec<S extends SnsSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected SnsSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends SnsSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
