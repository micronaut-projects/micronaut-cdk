 ...
 */
@ResourceSpec(component = Stream.class)
public class StreamSpec<S extends StreamSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected StreamSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends StreamSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
