 ...
 */
@ResourceSpec(component = Subnet.class)
public class SubnetSpec<S extends SubnetSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected SubnetSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends SubnetSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
