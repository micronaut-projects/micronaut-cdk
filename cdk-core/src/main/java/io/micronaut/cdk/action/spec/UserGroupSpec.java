 ...
 */
@ResourceSpec(component = UserGroup.class)
public class UserGroupSpec<S extends UserGroupSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected UserGroupSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends UserGroupSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
