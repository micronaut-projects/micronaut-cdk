 ...
 */
@ResourceSpec(component = User.class)
public class UserSpec<S extends UserSpec<S>> extends Spec<S> {
     ...
     * @param stacks stacks
     */
    protected UserSpec(@NonNull String cdkId,
     ...
     */
    public abstract static class Builder<S extends UserSpec<S>, B extends Builder<S, B>> extends Spec.Builder<S, B> {
